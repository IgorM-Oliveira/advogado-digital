...
INSERT INTO processos (numero, comanda, tipo) VALUES
  (123, 'Comanda A', 1),
  (456, 'Comanda B', 2),
  (789, 'Comanda C', 1);
...
INSERT INTO partes (tipo, nome, contato, email, processo_id) VALUES
  (1, 'Parte A', 11111111, 'partea@example.com', 1),
  (2, 'Parte B', 22222222, 'parteb@example.com', 2),
  (1, 'Parte C', 33333333, 'partec@example.com', 3);
...
INSERT INTO movimentacoes (codigo, instancia, tipo, local_mov, status, processo_id) VALUES
  (1, 'Primeira Instância', 1, 'Fórum A', 'Em andamento', 1),
  (2, 'Segunda Instância', 2, 'Fórum B', 'Concluído', 2),
  (3, 'Primeira Instância', 1, 'Fórum C', 'Em andamento', 3);
